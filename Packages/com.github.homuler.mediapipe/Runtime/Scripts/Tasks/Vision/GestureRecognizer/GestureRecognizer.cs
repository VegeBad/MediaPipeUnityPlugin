...
#pragma warning restore IDE0052
		...
		private GestureRecognizer(
			...
			Tasks.Core.TaskRunner.PacketsCallback packetCallback) : base(graphConfig, runningMode, gpuResources,
			packetCallback)
		{
		...
		public GestureRecognizerResult Recognize(Image image,
		...
		/// </returns>
		public bool TryRecognize(Image image, Core.ImageProcessingOptions? imageProcessingOptions,
		...
		public bool TryRecognizeForVideo(Image image, long timestampMillisec,
			Core.ImageProcessingOptions? imageProcessingOptions, ref GestureRecognizerResult result)
		{
			using var outputPackets = RecognizeForVideoInternal(image, timestampMillisec, imageProcessingOptions);
			return TryBuildGestureRecognizerResult(outputPackets, ref result);
		}
