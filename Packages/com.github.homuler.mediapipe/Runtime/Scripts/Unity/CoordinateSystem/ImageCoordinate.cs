	...
	public static class ImageCoordinate
	{
			...
			bool isMirrored = false)
		{
			...
			var localX = ((IsXReversed(imageRotation, isMirrored) ? imageWidth - rectX : rectX) * width / imageWidth) +
			             xMin;
			var localY =
				((IsYReversed(imageRotation, isMirrored) ? imageHeight - rectY : rectY) * height / imageHeight) + yMin;
		...
		public static float3 ImageToPoint(UnityEngine.Rect rectangle, int x, int y, int z,
			int imageWidth, int imageHeight, RotationAngle imageRotation = RotationAngle.Rotation0,
			bool isMirrored = false) =>
			ImageToLocalPoint(x, y, z, rectangle.xMin, rectangle.xMax, rectangle.yMin, rectangle.yMax, imageWidth,
				imageHeight, imageRotation, isMirrored);
		...
		public static float3 ImageToPoint(UnityEngine.Rect rectangle, int3 position,
			...
			ImageToPoint(rectangle, position.x, position.y, position.z, imageSize.x, imageSize.y, imageRotation,
				isMirrored);
		...
		public static float3 ImageToPoint(UnityEngine.Rect rectangle, int x, int y,
			int imageWidth, int imageHeight, RotationAngle imageRotation = RotationAngle.Rotation0,
			bool isMirrored = false) =>
			ImageToLocalPoint(x, y, 0, rectangle.xMin, rectangle.xMax, rectangle.yMin, rectangle.yMax, imageWidth,
				imageHeight, imageRotation, isMirrored);
		...
		public static float3 ImageNormalizedToLocalPoint(float normalizedX, float normalizedY, float normalizedZ,
		...
		public static float3 ImageNormalizedToPoint(UnityEngine.Rect rectangle, float normalizedX, float normalizedY,
			float normalizedZ,
			float zScale, RotationAngle imageRotation = RotationAngle.Rotation0, bool isMirrored = false) =>
			ImageNormalizedToLocalPoint(normalizedX, normalizedY, normalizedZ, rectangle.xMin, rectangle.xMax,
		...
		/// </param>
		/// <param name="isMirrored">Set to true if the original coordinates is mirrored</param>
		public static float3 ImageNormalizedToPoint(UnityEngine.Rect rectangle, Vector3 position,
			RotationAngle imageRotation = RotationAngle.Rotation0, bool isMirrored = false) =>
		...
		/// </param>
		/// <param name="isMirrored">Set to true if the original coordinates is mirrored</param>
		public static float3 ImageNormalizedToPoint(UnityEngine.Rect rectangle, Vector2 position,
			RotationAngle imageRotation = RotationAngle.Rotation0, bool isMirrored = false)
		...
		public static Vector3[] ImageToRectVertices(UnityEngine.Rect rectangle, int xMin, int yMin, int width,
			...
			ImageToRectVertices(rectangle, xMin, yMin, width, height, imageSize.x, imageSize.y, imageRotation,
				isMirrored);
		...
		public static Vector3[] ImageToRectVertices(UnityEngine.Rect rectangle, int xCenter, int yCenter, int width,
			int height, float rotation,
			Vector2Int imageSize, RotationAngle imageRotation = RotationAngle.Rotation0, bool isMirrored = false) =>
			ImageToRectVertices(rectangle, xCenter, yCenter, width, height, rotation, imageSize.x, imageSize.y,
				imageRotation, isMirrored);
		...
		public static float2 GetPoint(this UnityEngine.Rect rectangle, mplt.RelativeKeypoint relativeKeypoint,
			RotationAngle imageRotation = RotationAngle.Rotation0, bool isMirrored = false)
		{
			var value = ImageNormalizedToPoint(rectangle, relativeKeypoint.X, relativeKeypoint.Y, imageRotation,
				isMirrored);
		...
		public static float2 GetPoint(this UnityEngine.Rect rectangle, mptcc.NormalizedKeypoint normalizedKeypoint,
			RotationAngle imageRotation = RotationAngle.Rotation0, bool isMirrored = false)
		{
			var value = ImageNormalizedToPoint(rectangle, normalizedKeypoint.x, normalizedKeypoint.y, imageRotation,
				isMirrored);
			return new float2(value.x, value.y);
		}
		...
		public static float3 GetPoint(this UnityEngine.Rect rectangle, NormalizedLandmark normalizedLandmark,
			RotationAngle imageRotation = RotationAngle.Rotation0, bool isMirrored = false) =>
			ImageNormalizedToPoint(rectangle, normalizedLandmark.X, normalizedLandmark.Y, normalizedLandmark.Z,
				imageRotation, isMirrored);
		...
		public static Vector3[] GetRectVertices(this UnityEngine.Rect rectangle, mplt.BoundingBox boundingBox,
			...
			RotationAngle imageRotation = RotationAngle.Rotation0, bool isMirrored = false) =>
			ImageToRectVertices(rectangle, boundingBox.Xmin, boundingBox.Ymin, boundingBox.Width, boundingBox.Height,
		...
		public static Vector3[] GetRectVertices(this UnityEngine.Rect rectangle, mplt.RelativeBoundingBox boundingBox,
			RotationAngle imageRotation = RotationAngle.Rotation0, bool isMirrored = false) =>
			ImageNormalizedToRectVertices(rectangle, boundingBox.Xmin, boundingBox.Ymin, boundingBox.Width,
		...
		public static Vector3[] GetRectVertices(this UnityEngine.Rect rectangle, mptcc.Rect rect, int imageWidth,
			int imageHeight,
			RotationAngle imageRotation = RotationAngle.Rotation0, bool isMirrored = false) =>
			ImageToRectVertices(rectangle, rect.left, rect.top, rect.right - rect.left, rect.bottom - rect.top,
				imageWidth, imageHeight, imageRotation, isMirrored);
		...
		public static Vector3[] GetRectVertices(this UnityEngine.Rect rectangle, Rect rect, int imageWidth,
			int imageHeight,
			RotationAngle imageRotation = RotationAngle.Rotation0, bool isMirrored = false) =>
			ImageToRectVertices(rectangle, rect.XCenter, rect.YCenter, rect.Width, rect.Height, rect.Rotation,
				imageWidth, imageHeight, imageRotation, isMirrored);
		...
		public static Vector3[] GetRectVertices(this UnityEngine.Rect rectangle, NormalizedRect normalizedRect,
			RotationAngle imageRotation = RotationAngle.Rotation0, bool isMirrored = false) =>
			ImageNormalizedToRectVertices(rectangle, normalizedRect.XCenter, normalizedRect.YCenter,
		...
		/// </param>
		/// <param name="isMirrored">Set to true if the original coordinates is mirrored</param>
		public static float2 PointToImageNormalized(this UnityEngine.Rect rectangle, float2 localPosition,
			RotationAngle imageRotation = RotationAngle.Rotation0, bool isMirrored = false)
		{
			...
			return IsInverted(imageRotation)
				? new float2(normalizedY, normalizedX)
				: new float2(normalizedX, normalizedY);
		}
