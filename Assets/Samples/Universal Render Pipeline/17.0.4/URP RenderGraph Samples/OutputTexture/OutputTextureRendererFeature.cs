...
public class OutputTextureRendererFeature : ScriptableRendererFeature
{
	...
	class OutputTexturePass : ScriptableRenderPass
	{
		...
		public override void RecordRenderGraph(RenderGraph renderGraph, ContextContainer frameData)
		{
			...
			{
				Debug.Log(
					"Input texture is not created. Likely the pass event is before the creation of the resource. Skipping OutputTexturePass.");
				return;
			}
	...
	[SerializeField] RenderPassEvent m_PassEvent = RenderPassEvent.AfterRenderingTransparents;
	[SerializeField] string m_TextureName = "_InputTexture";
	[SerializeField] TextureType m_TextureType;
