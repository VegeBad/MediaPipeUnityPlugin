...
namespace Mediapipe.Unity.Sample.FaceDetection
{
    ...
    Tasks.Core.BaseOptions.Delegate.GPU;
		...
		public Tasks.Vision.FaceDetector.FaceDetectorOptions GetFaceDetectorOptions(
			Tasks.Vision.FaceDetector.FaceDetectorOptions.ResultCallback resultCallback = null)
		{
