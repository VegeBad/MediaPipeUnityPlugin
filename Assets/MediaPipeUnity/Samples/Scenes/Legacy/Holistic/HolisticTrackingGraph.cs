	...
	public class HolisticTrackingGraph : GraphRunner
	{
		...
		protected override void ConfigureCalculatorGraph(CalculatorGraphConfig config)
		{
			...
			_poseLandmarksStream =
				new OutputStream<NormalizedLandmarkList>(calculatorGraph, _PoseLandmarksStreamName, true);
			_faceLandmarksStream =
				new OutputStream<NormalizedLandmarkList>(calculatorGraph, _FaceLandmarksStreamName, true);
			_leftHandLandmarksStream =
				new OutputStream<NormalizedLandmarkList>(calculatorGraph, _LeftHandLandmarksStreamName, true);
			_rightHandLandmarksStream =
				new OutputStream<NormalizedLandmarkList>(calculatorGraph, _RightHandLandmarksStreamName, true);
			_poseWorldLandmarksStream =
				new OutputStream<LandmarkList>(calculatorGraph, _PoseWorldLandmarksStreamName, true);
